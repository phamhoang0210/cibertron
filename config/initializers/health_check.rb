HealthCheck.setup do |config|
  ...
  config.basic_auth_username = 's172'
  config.basic_auth_password = 's172'
  ...
  config.add_custom_check('sometest') do
    HealthCheckService.perform_another_check # any code that returns blank on success and non blank string upon failure
  end
end
