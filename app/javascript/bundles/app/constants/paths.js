...
export const NAUH_BASE_URL = process.env.NODE_ENV == 'production' ? 'https://nauh.edumall.io' : 'https://nauh.edumall.io'
...
export const AMUN_BASE_URL = process.env.NODE_ENV == 'production' ? 'https://amun.edumall.io.vn' : 'http://localhost:9008'
