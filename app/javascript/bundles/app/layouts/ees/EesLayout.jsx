...
import 'styles/app/layouts/ees/ees_layout'

const { Sider, Content } = Layout
const { ItemGroup, SubMenu } = Menu
const SIDER_COLLAPSED_KEY = 'ees_layout_sider_collapsed'

class EesLayout extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout className="layout-wraper ees-layout">
        <Sider
          width={230}
