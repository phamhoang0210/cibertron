...
import 'styles/app/layouts/izzy/izzy_layout'

const { Sider, Content } = Layout
const { ItemGroup, SubMenu } = Menu
const SIDER_COLLAPSED_KEY = 'izzy_layout_sider_collapsed'

class IzzyLayout extends React.Component {
