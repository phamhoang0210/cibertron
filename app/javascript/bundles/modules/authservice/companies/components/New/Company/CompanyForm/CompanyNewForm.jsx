...
class CompanyNewForm extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleSubmit(e) {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        actions.createCompany({company: values})
      }
    })
  }
  ...
  render() {
    ...
    const isCreatingCompany = newState.get('isCreatingCompany')
          ...
          <Col span={10}>
            <Form onSubmit={this.handleSubmit} layout="horizontal">
              ...
              <FormItem  {...DEFAULT_BUTTON_ITEM_LAYOUT}>
                <Button type="primary" htmlType="submit" loading={isCreatingCompany}>
...
export default Form.create()(CompanyNewForm)