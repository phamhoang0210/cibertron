...
import { Form, Input, Row, Col, Button, Select, Alert, Spin, Tabs } from 'antd'
const { TabPane } = Tabs
...
class AccountEditForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        actions.updateAccount(account.get('id'), {account: values})
      }
    })
  }
                  ...
                  <Form onSubmit={this.handleSubmit} layout="horizontal">
                    <FormItem label="Email" {...this.formItemLayout}>
                      {getFieldDecorator('email', {
                        initialValue: account.get('email')
                      })(<Input disabled/>)}
                    </FormItem>
...
export default Form.create()(AccountEditForm)